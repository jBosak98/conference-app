...
class _ChatPageState extends State<ChatPage> {
          ...
          child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      buildListMessages(args.roomId),
                      buildInput(args.roomId)
                    ],
                  )
                ],
              ))),
  ...
  Widget buildListMessages(roomId) => Flexible(
        child: Center(
            child: StreamBuilder(
  ...
  bool _isItMe(messageUserId) => messageUserId == widget.chatBloc.getMyUserId();
  ...
  _buildMessage(int index, QueryDocumentSnapshot document) => Row(
  ...
  Widget _otherMessage(QueryDocumentSnapshot document) => Row(
  ...
  Widget buildInput(roomId) => Container(
      color: Colors.white,
      child: Row(
        children: <Widget>[
          Flexible(
          ...
          Material(
            child: new Container(
              ...
              child: new IconButton(
                ...
                onPressed: () =>
                    onSendMessage(textEditingController.text, roomId),
              ),
            ),
            color: Colors.white,
          ),
